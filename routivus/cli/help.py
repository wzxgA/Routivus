...
from routivus.cli.commands import SLASH_COMMANDS, SlashCommandSpec, SlashSubcommandSpec
...
DETAILS_EN = {
    ...
    "/web": ("Web results are external, untrusted data and do not change Routivus policy.",),
    ...
    "/init": ("Analyze the current project and prepare an Routivus.md draft without overwriting an existing file.",),
